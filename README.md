...
export MAMBA_EXE='/home/YOUR_USERNAME/.local/bin/micromamba'; # Defines full path to mamba executable
export MAMBA_ROOT_PREFIX='/home/YOUR_USERNAME/micromamba'; # Dictates where environments and packages are stored
...
Create jupyterenv on micromamba:
```
micromamba create -n jupyterenv python-3.11 jupyterlab -c conda-forge
```
